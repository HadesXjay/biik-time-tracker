      ...
      <div className="max-w-4xl mx-auto flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="text-xs bg-red-900/20 text-red-500 px-3 py-1 rounded-md border border-red-900/30 hover:bg-red-900/40"
          >
            LOGOUT
          </button>
        </div>
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        ...
        <div className="bg-[#1e1e1e] p-8 rounded-3xl border border-[#333] flex flex-col items-center">
          <input 
            ...
            className="bg-transparent text-center text-lg mb-4 outline-none border-b border-[#333] focus:border-white w-full pb-2" 
          />
          <div className="text-6xl font-mono font-black mb-8">{formatTime(seconds)}</div>
          <div className="flex gap-3 w-full">
            <button 
              onClick={toggleTimer} 
              className={`flex-1 py-4 rounded-xl font-bold transition-all ${isActive ? "bg-yellow-600" : "bg-white text-black hover:bg-gray-200"}`}
            >
